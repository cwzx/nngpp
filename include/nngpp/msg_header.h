...
public:
	...
	void append_u16( uint16_t val ) const {
		int r = nng_msg_header_append_u16(m,val);
		if( r != 0 ) {
			throw exception(r,"nng_msg_header_append_u16");
		}
	}
	...
	void append_u64( uint64_t val ) const {
		int r = nng_msg_header_append_u64(m,val);
		if( r != 0 ) {
			throw exception(r,"nng_msg_header_append_u64");
		}
	}
	
	void insert_u16( uint16_t val ) const {
		int r = nng_msg_header_insert_u16(m,val);
		if( r != 0 ) {
			throw exception(r,"nng_msg_header_insert_u16");
		}
	}
	...
	void insert_u64( uint64_t val ) const {
		int r = nng_msg_header_insert_u64(m,val);
		if( r != 0 ) {
			throw exception(r,"nng_msg_header_insert_u64");
		}
	}
	
	uint16_t trim_u16() const {
		uint16_t val;
		int r = nng_msg_header_trim_u16(m,&val);
		if( r != 0 ) {
			throw exception(r,"nng_msg_header_trim_u16");
		}
		return val;
	}
	...
	uint64_t trim_u64() const {
		uint64_t val;
		int r = nng_msg_header_trim_u64(m,&val);
		if( r != 0 ) {
			throw exception(r,"nng_msg_header_trim_u64");
		}
		return val;
	}
	...
	uint16_t chop_u16() const {
		uint16_t val;
		int r = nng_msg_header_chop_u16(m,&val);
		if( r != 0 ) {
			throw exception(r,"nng_msg_header_chop_u16");
		}
		return val;
	}
	...
	uint64_t chop_u64() const {
		uint64_t val;
		int r = nng_msg_header_chop_u64(m,&val);
		if( r != 0 ) {
			throw exception(r,"nng_msg_header_chop_u64");
		}
		return val;
	}
